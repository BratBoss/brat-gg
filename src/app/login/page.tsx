        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <input
              ...
              disabled={busy}
              className="w-full px-4 py-3 rounded-md bg-[#161d17] border border-[#2a3a2c] text-[#d6e4d2] placeholder-[#4a5e4c] text-sm focus:outline-none focus:border-[#5e7d5a] transition-colors disabled:opacity-50"
            />
