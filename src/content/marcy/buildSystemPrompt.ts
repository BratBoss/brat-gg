// Edit system-prompt.md to change Marcy's character/behavior.
...
const rawMd = fs.readFileSync(
  path.join(process.cwd(), "src/content/marcy/system-prompt.md"),
  "utf-8"
);
...
export function buildMarcySystemPrompt({
  userName,
  currentDate,
  historySummary = null,
}: {
